...
class Session:
    ...
    def is_active(self):
        # Increased timeout from 60s to 120s to reduce false disconnects on slow pages
...
class TMWebDriver:  
    def __init__(self, host: str = '127.0.0.1', port: int = 18765):  
        ...
        # Note: connect_ex returns 0 on success, so this checks if a server is already running
    ...
    def start_http_server(self):
        ...
        def long_poll():
            ...
            # TODO: investigate why reconnect check uses queue.Queu (truncated in original) -- using queue.Queue here
